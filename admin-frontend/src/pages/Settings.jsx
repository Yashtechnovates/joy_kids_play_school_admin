...
const Settings = () => {
  ...
  const [profile, setProfile] = useState({
    ...
    email: storedCredentials.email || 'admin@joyschool.com',
    phone: storedProfile.phone || '+91 98765 43210'
  });
  ...
  const handleProfileUpdate = () => {
    ...
    if (!usernameRegex.test(profile.username)) {
      toast.error('Username should be 3-20 characters and can include letters, numbers, and underscores');
      return;
    }
    ...
    const updatedUser = {
      ...
      avatar: existingUser.avatar || `https://ui-avatars.com/api/?name=${encodeURIComponent(profile.name)}&background=3b82f6&color=fff`
    };
